...
// --- BOUTON WHATSAPP (Version complète avec ton SVG et ton message) ---
const FloatingWhatsApp = () => {
  ...
  const handleWhatsAppClick = async (e) => {
    ...
    try {
      ...
      window.open(`https://wa.me/22899794772?text=${encodeURIComponent("Bonjour Emile Auto, j'aurais besoin d'une assistance concernant un véhicule.")}`, "_blank");
    }
  };
