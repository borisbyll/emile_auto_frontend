      ...
      <main className="flex-1 ml-64">
        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <a className="flex items-center gap-2 group" href="/" data-discover="true">
            ...
            <span className="text-xl font-black tracking-tighter uppercase text-slate-900">Emile <span className="text-amber-600">Auto</span></span>
          </a>
          <div className="hidden md:flex gap-10 items-center">
            <a className="text-[10px] font-bold uppercase tracking-[0.2em] text-slate-400 hover:text-slate-900 transition-colors" href="/" data-discover="true">Accueil</a>
            <a className="text-[10px] font-bold uppercase tracking-[0.2em] text-slate-400 hover:text-slate-900 transition-colors" href="/Catalogue" data-discover="true">Inventaire</a>
            <a className="px-5 py-2 bg-slate-50 text-slate-900 rounded-full text-[9px] font-black uppercase tracking-widest border border-slate-200 hover:bg-slate-900 hover:text-white transition-all" href="/Admin" data-discover="true">Espace Admin</a>
          </div>
        </div>
